...
const comingSoon: React.FC<ErrGenericProps> = ({
  title = "This feature is coming soon..",
  message = "We are currently working on this feature, please come back later.",
  ...
  return (
    <View className="flex-1 justify-center items-center bg-gray-200 px-6 min-h-[400px]">
      <StatusBar backgroundColor="transparent" />
      <View className="w-full max-w-md">
        {/* Visual Error Indicator */}
        <View className="mb-8 items-center">
          <Animated.View
            className="w-24 h-24 rounded-full  from-indigo-100 to-purple-100 items-center justify-center mb-2"
            style={{ transform: [{ scale: pulseAnim }] }}
          >
            <View className="w-16 h-16 rounded-full bg-white items-center justify-center">
              <Entypo name="back-in-time" size={36} color="#black" />
            </View>
          </Animated.View>
